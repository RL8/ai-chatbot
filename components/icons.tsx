...
export const MusicIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.5 1.5C13.5 0.671573 12.8284 0 12 0C11.1716 0 10.5 0.671573 10.5 1.5V6.5L6.5 4.5V12.5C6.5 13.3284 5.82843 14 5 14C4.17157 14 3.5 13.3284 3.5 12.5C3.5 11.6716 4.17157 11 5 11C5.41421 11 5.78921 11.149 6.08579 11.4142L10.0858 7.41421C10.2763 7.22368 10.5 7.22368 10.5 7.41421V1.5ZM12 1.5C12 1.22386 12.2239 1 12.5 1C12.7761 1 13 1.22386 13 1.5C13 1.77614 12.7761 2 12.5 2C12.2239 2 12 1.77614 12 1.5ZM5 12.5C5 12.2239 5.22386 12 5.5 12C5.77614 12 6 12.2239 6 12.5C6 12.7761 5.77614 13 5.5 13C5.22386 13 5 12.7761 5 12.5Z"
        fill="currentColor"
      />
    </svg>
  );
